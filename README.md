...
You should replace the IP address with your IP address or domain on line 3 and 12 of the file. If your Shiny Server does not run in the default port, you should replace the port 3838 to the port your Shiny Server uses.
